...
np.savetxt('SB_9351_singles.txt',simples,fmt='%s')
np.savetxt('SB_9351_doubles.txt',doubles,fmt='%s')
np.savetxt('SB_9351_multi.txt',triples,fmt='%s')
